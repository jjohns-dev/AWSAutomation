...
@{
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            LicenseUri = 'https://github.com/jjohns-dev/AWSAutomation/blob/main/LICENSE'

            # A URL to the main website for this project.
            ProjectUri = 'https://github.com/jjohns-dev/AWSAutomation'
    ...
    # HelpInfoURI       = 'https://github.com/jjohns-dev/AWSAutomation'
